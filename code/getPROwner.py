...
#try: 
proj_list=[['angular', 'angular.js'],['bitcoin','bitcoin'],['twbs','bootstrap'],['BVLC','caffe'],
['d3','d3'],['django','django'],['docker','docker'],['pallets','flask'],['jenkinsci','jenkins'],['joomla','joomla-cms'],
['jquery','jquery'],['laravel','laravel'],['mongodb','mongo'],['opencv','opencv'],['rails','rails'],['facebook','react'],
['antirez','redis'],['scikit-learn','scikit-learn'],
...
for project in proj_list:
    ...
    list_PRs = []
    print owner+"/"+repo+": " + str(len(list_users)) + " usuarios com PRs closed"
